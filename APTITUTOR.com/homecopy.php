...
<a href="Projectx/quiz2.php?n=1">OOPs</a>
  ...
  <li class="w3-hide-small"><a href="tutorials.html" class="w3-padding-large w3-hover-blue">Tutorials</a></li>
<div class="dropdown" style="float:left;">
...
<a href="Projectx/quiz.php?n=1">
  ...
  <button type="submit" class="w3-btn w3-padding-16 w3-large w3-margin-top">Start Aptitude Test.!</button>
</a>
</header>
</div>
